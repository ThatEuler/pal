...
local function combat()
  ...
  if
    autoStun and toggle("interrupts", false) and target.interrupt() and target.distance < 8 and -spell(SB.Rebuke) > 0 and
  ...
  if
    -player.health < 45 and castable(SB.GuardianofAncientKings) and -spell(SB.ArdentDefender) > 0 and
